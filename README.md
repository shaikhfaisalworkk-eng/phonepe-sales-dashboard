...
* 💰 Total transaction value and transaction volume
...
* Donut Chart for age-segment contribution
* Bar Charts for service analysis and Top 5 users
* Donut Chart for weekday vs. weekend usage
...
* **Gen X and Millennials** are the largest age-segment contributors.
* Transaction values fluctuate across different months, highlighting variations in payment activity.
...
* Add transaction success/failure trends
